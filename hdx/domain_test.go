...
// HTTP behaviour is covered in hdx_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "hdx://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("hdx", "about")
	if err != nil || got.String() != "hdx://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want hdx://page/about", got.String(), err)
	}
}
