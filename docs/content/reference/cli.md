...
```
hdx <command> [arguments] [flags]
```

Run `hdx <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `hdx/domain.go`.
