...
Most of these come down to network reality or how hdx serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

hdx rate-limits like any public site. hdx already paces
...
Where a surface is gated, hdx reads a cookie or token you supply
...
`hdx`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hdx actually did
